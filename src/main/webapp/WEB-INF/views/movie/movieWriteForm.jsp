 ...
 */
function chk() {
	oEditors.getById["mvContent"].exec("UPDATE_CONTENTS_FIELD", []);
	var COMVISION = document.getElementById("mvContent").value;
	if (COMVISION == "" || COMVISION == null || COMVISION == '&nbsp;'
		...
		|| COMVISION == '<p>&nbsp;</p>' || COMVISION == '<p><br></p>') {
			...
			oEditors.getById["mvContent"].exec("FOCUS"); //포커싱
					...
					<form action="movieWrite.mv" name="movieWrite" id="movieWrite"
						...
						<table border="1" id="boardtable">
							<tbody>
								...
								<tr>
									<th>무비 태그</th>
									<td><select class="mvTag" name="mvTag">
								...
								<tr>
									<th>개봉일</th>
									<td><input type="date" name="openDate"
										autofocus="autofocus" size="50" maxlength="255" required="required"></td>
								</tr>
								...
								<tr>
									<th>출연배우</th>
									<td><input type="text" name="majorActor"
										autofocus="autofocus" size="50" maxlength="255" required="required"></td>
								</tr>
								<tr>
									<th>영화 정보</th>
									<td><input type="text" name="mvInfo"
										autofocus="autofocus" size="50" maxlength="255" required="required"></td>
								</tr>
								<tr>
									<th>장르</th>
								...
								<tr>
									<th>영화 등급</th>
									<td><input type="number" name="mvGrade"
										autofocus="autofocus" size="50" maxlength="255" required="required"></td>
								</tr>
								<tr>
									<th>평점</th>
								...
								<tr>
									<th>영화 가격</th>
									<td><input type="number" name="mvPrice"
										autofocus="autofocus" size="50" maxlength="255" required="required"></td>
								</tr>								
								<tr>
									<th>이미지 올리기</th>
								...
								<option value="${list.ttCode }">극장코드:${list.ttCode },극장위치:${list.theaterLoc },극장이름:${list.theaterName }</option>
								</c:forEach>
								</select>
								...
								<tr>
									<td class="contentArea" colspan="2"><textarea rows="18"
											cols="152" id="mvContent" name="mvContent"></textarea></td>
								</tr>
							</tbody>
						</table>
