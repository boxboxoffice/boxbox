      ...
      <ul class="navbar-nav text-right"><!-- 오른쪽 정렬하기 text-right-->
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="reviewSpiView.rv">스파이더맨 노 웨이 홈</a></li>
            <li><a class="dropdown-item" href="review0View.rv">극장판 주술회전 0</a></li>
            <li><a class="dropdown-item" href="reviewBatView.rv">더 배트맨</a></li>
            <li><a class="dropdown-item" href="reviewSingView.rv">씽2게더</a></li>
            <li><a class="dropdown-item" href="reviewMathView.rv">이상한 나라의 수학자</a></li>
            <li><a class="dropdown-item" href="reviewMoonView.rv">문폴</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
