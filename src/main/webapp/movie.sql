...
-- 영화 DB
	...
	INSERT INTO movie
	VALUES( 16, '이상한 나라의 수학자' , 2 , '2022.3.9' , '박동훈' , '최민식' , '117분' , '드라마', 'Mathematician.jpg' , '이상한 나라의 수학자는 최민식의 코미디나 로맨스 비중이 많은 드라마틱한 영화이다.' , '정답만을 찾는 세상에서 방황하던 `한지우`에게 올바른 풀이 과정을 찾아나가는 법을 가르치며 `이학성` 역시 뜻하지 않은 삶의 전환점을 맞게 된다.' , 10000 , 8 , '12세 이상 관람가');
	INSERT INTO movie
