...
-- 영화 DB
	INSERT INTO movie
	VALUES( 1, '스파이더맨 노 웨이 홈' , 2 , '2021.12.15' , '존 왓츠' , '톰 홀랜드', '148분', '액션', 'SpiderMan.jpg', '스파이더맨: 노 웨이 홈은 마블 시네마틱 유니버스의 27번째 장편 영화다. 스파이더맨 시리즈의 3번째 작품', '정체가 탄로난 스파이더맨 피터 파커(톰 홀랜드)가 문제를 해결하기 위해 닥터 스트레인지(베네딕트 컴버배치)의 도움을 받던 중 뜻하지 않게 멀티버스가 열리게 되고, 이를 통해 닥터 옥토퍼스(알프리드 몰리나) 등 각기 다른 차원의 숙적들이 나타나며 사상 최악의 위기를 맞게 되는데....', 10000 , 9, 5 , '12세 이상 관람가');
	INSERT INTO movie
	VALUES( 2, '닥터 스트레인지 : 대혼돈의 멀티버스' , 3 , '2022.5.4' , '샘 레이미' , '베네딕트 컴버배치' , '미정' , '액션' , 'DoctorStrange.jpg' , '마블 시네마틱 유니버스 페이즈 4의 5번째 영화이자, 닥터 스트레인지 실사영화 시리즈이며 6년만에 개봉하는 2번째 작품이다.' , '스티븐 스트레인지 박사는 멀티버스의 문을 여는 금기의 주문을 시전하여 다른 차원의 스트레인지와 맞닥뜨린다. 다른 차원의 스트레인지에 대항하고자 힘을 모은다.' , 10000 , 0, 5 , '15세 이상 관람가');
	INSERT INTO movie
	VALUES( 3, '반지의 제왕: 반지 원정대' , 1 , '2001.5.4' , '피터 잭슨' , '숀 애스틴' , '558분' , '판타지' , 'TheRordOftheRing.jpg' , 'J. R. R. 톨킨이 집필한 판타지 소설 《반지의 제왕》의 실사 영화 3부작.' , '절대 반지를 손에 넣게 된 프로도 베긴스는 반지를 파괴해 중간계를 구하기 위해, 반지 원정대와 같이 여정을 떠나는데... ', 10000 , 9, 5 , '12세 이상 관람가');
	INSERT INTO movie
	VALUES( 4, '극장판 주술회전 0' , 2 , '2021.12.24' , '박성후' , '오가타 메구미' , '105분' , '에니메이션' , 'GekijoubanJujutsuKaisen0.jpg' , '아쿠타미 게게의 만화 주술회전 0권을 원작으로 하는 극장판이자 제작사 MAPPA의 이 세상의 한구석에 이후 5년만의 2번째 극장 애니메이션이다.' , '주술사만의 낙원을 만들려는 게토는 비술사를 섬멸하겠다면서, 신주쿠와 교토에 천의 저주를 내리는데… 과연 옷코츠는 게토를 막을 수 있을까? 그리고 리카의 저주를 풀 수 있을까?' , 10000 , 8, 5 , '15세 이상 관람가');
	INSERT INTO movie
	VALUES( 5, '이터널스' , 1 , '2021.11.3' , '클로이 자오' , '마동석' , '156분' , '액션' , 'Eternals.jpg' , '마블 시네마틱 유니버스에 등장하는 외계 종족 집단 이터널스의 이야기' , '외계에서 고대 지구에 도래한 존재들인 이터널스, 고대 인류를 이끌긴 해도, 셀레스티얼의 지시로 데비안츠와 관련된 사건 외에는 인류사에 직접적으로 개입하지는 않았던 이들에게 어느 순간 이변이 일어나는데...', 10000 , 6 , 4 , '12세 이상 관람가');
	INSERT INTO movie
