...
-- 영화 DB
	...
	INSERT INTO movie
	VALUES( 3, '반지의 제왕' , 1 , '2001.5.4' , '피터 잭슨' , '숀 애스틴' , '558분' , '판타지' , 'TheRordOftheRing.jpg' , 'J. R. R. 톨킨이 집필한 판타지 소설 《반지의 제왕》의 실사 영화 3부작.' , '절대 반지를 손에 넣게 된 프로도 베긴스는 반지를 파괴해 중간계를 구하기 위해, 반지 원정대와 같이 여정을 떠나는데... ', 10000 , '9.36점', 5 , '12세 이상 관람가');
	INSERT INTO movie
