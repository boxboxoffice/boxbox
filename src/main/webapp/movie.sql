...
반지 원정대와 같이 여정을 떠나는데... ', 10000 , 9, 5 , '12세 이상 관람가');
	INSERT INTO movie
	VALUES( 4, '극장판 주술회전 0' , 2 , '2021.12.24' , '박성후' , '오가타 메구미' , '105분' , '에니메이션' , 'GekijoubanJujutsuKaisen0.jpg' , '아쿠타미 게게의 만화 주술회전 0권을 원작으로 하는 극장판이자<br>
...
인류사에 직접적으로 개입하지는 않았던 이들에게 어느 순간 이변이 일어나는데...', 10000 , 6 , 4 , '12세 이상 관람가');
	...
	INSERT INTO movie
	VALUES( 7, '조커' , 1 , '2019.10.2' , '토드 필립스' , '호아킨 피닉스' , '123분' , '범죄' , 'Joker.jpg' , '호아킨 피닉스가 주연을 맡아 DC 코믹스의 캐릭터 조커를 연기하는 토드 필립스 감독의 범죄 스릴러 영화.<br>
...
버스터 문은 완벽한 라이브를 위해 종적을 감춘 레전드 뮤지션 클레이(보노)를 캐스팅하겠다는 파격 선언을 하는데!' , 10000 , 7 , 5 , '전체이용가');
	INSERT INTO movie
	VALUES( 10, '수퍼 소닉 2' , 3 , '2022.4.6' , '제프 파울러' , '짐 캐리' , '110분 ', '액션' , 'Sonic2.jpg' , '2022년 4월 8일 개봉 예정인 원작 소닉 더 헤지혹 시리즈의 2번째 실사 영화이자<br>
...
위기를 모면하게 되고 소닉과 테일즈, 로보트닉과 너클즈의 지구를 사수하기 위한 상황이 시작된다.' , 10000 , 9 , 4 , '전체이용가');
	INSERT INTO movie
	VALUES( 11, '잭 스나이더의 저스티스 리그' , 1 , '2021.3.18' , '잭 스나이더' , '벤 에플렉' , '362분' , '액션' , 'Justiceleague.jpg' , 'DC 확장 유니버스의 5번째 영화 저스티스 리그의 감독판이다. 일명 스나이더 컷으로 불린다.<br>
...
이후 브루스 웨인은 산을 넘어 어느 외딴 항구 마을에 도착한다.', 10000  , 7 , 4 , '12세 이상 관람가');
	INSERT INTO movie
	VALUES( 12, '토르 : 러브 앤 썬더' , 3 , '2022.7.8' , '타이카 와이티티' , '크리스 헴스워스' , '133분' , '액션' , 'Thor4.jpg' , '마블 시네마틱 유니버스 페이즈 4의 6번째 작품이자 토르 실사영화 시리즈의 4번째 작품이며 5년만에 개봉하는 영화이다.<br>
...
최대 시속 50km, 남은 시간은 3시간… 유일한 희망인 스텔라와 함께 보스의 슈퍼카를 반드시 찾아야만 한다!' , 10000 , 0 , 4 , '12세 이상 관람가');
	INSERT INTO movie
	VALUES( 15, '어벤져스 : 엔드게임' , 1 , '2019.4.24' , '앤서니 루소, 조 루소' , '로버트 다우니 주니어' , '249분' , '액션', 'avengers.jpg' , '어벤져스 실사영화 시리즈의 4번째 작품이자, 마블 시네마틱 유니버스의 스물 두번째 작품이며<br>
페이즈 3의 10번째 작품이자 지난 2008년<br>
